...
st.write(' ')
st.write('2) Also, a better understanding of the geographical features in the terrain could help to make a more effective decision in feaure engineering and feature selection.')
